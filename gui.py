...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.BoardConfigLabel = QtWidgets.QLabel(self.widget)
        ...
        self.BlobLabel = QtWidgets.QLabel(self.widget)
        ...
        self.IPSWLabel = QtWidgets.QLabel(self.widget)
        ...
        self.IdentifierLabel = QtWidgets.QLabel(self.widget)
        ...
        self.widget1.setGeometry(QtCore.QRect(10, 240, 451, 81))
        ...
        self.LegacyCheckBox = QtWidgets.QCheckBox(self.widget1)
        ...
        self.KPPCheckBox = QtWidgets.QCheckBox(self.widget1)
        ...
        self.RestoreMode = QtWidgets.QRadioButton(self.splitter)
        ...
        self.BootMode = QtWidgets.QRadioButton(self.splitter)
        self.BootMode.setObjectName("BootMode")
        self.gridLayout_2.addWidget(self.splitter, 0, 4, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(268, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem, 0, 3, 1, 1)
        self.SkipBasebandCheckBox = QtWidgets.QCheckBox(self.widget1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LegacyCheckBox.setText(_translate("MainWindow", "Legacy mode"))
